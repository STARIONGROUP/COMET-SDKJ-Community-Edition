...
class ParameterGroupComparatorTest {
    @Test
    void testComparator() {
      ParameterGroup parameter1 = new ParameterGroup();
        parameter1.setName("type1");
      ParameterGroup parameter2 = new ParameterGroup();
        parameter2.setName("type5");

      ParameterGroupComparator comparator = new ParameterGroupComparator();
