...
/**
 * Default comparer to be used when comparing {@link ValueArray<String>}s of the String type.
 */
public class StringValueSetComparator implements Comparator<ValueArray<String>> {
    /**
