...
public class MappingToReferenceScale extends Thing implements Cloneable {
     ...
     */
    public MappingToReferenceScale(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * The unique identifier of the referenced dependentScaleValue.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID dependentScaleValue;

    /**
     * The unique identifier of the referenced referenceScaleValue.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID referenceScaleValue;

    /**
     * Gets the route for the current {@link MappingToReferenceScale}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.MappingToReferenceScale} from a {@link MappingToReferenceScale}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.sitedirectorydata.MappingToReferenceScale(this.getIid(), cache, uri);
    }
}
