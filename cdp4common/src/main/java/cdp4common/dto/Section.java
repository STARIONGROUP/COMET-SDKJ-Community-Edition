...
/**
 * A Data Transfer Object representation of the {@link "Section"} class.
 */
...
public class Section extends Thing implements Cloneable, CategorizableThing, NamedThing, OwnedThing, ShortNamedThing, TimeStampedThing {
    ...
    public Section() {
        ...
        this.page = new ArrayList<OrderedItem>();
    }
     ...
     */
    public Section(UUID iid, int rev) {
        super(iid, rev);
        this.category = new ArrayList<UUID>();
        this.page = new ArrayList<OrderedItem>();
    }
    ...
    /**
     * The unique identifiers of the contained page instances.
     */
    @UmlInformation(aggregation = AggregationKind.COMPOSITE, isDerived = false, isOrdered = true, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private ArrayList<OrderedItem> page;
    ...
    /**
     * Gets the route for the current {@link Section}.
     */
    @Override
    ...
    public List<List> getContainerLists() {
        ...
        containers.add(this.getPage());
        return containers;
    }

    /**
     * Instantiate a {@link cdp4common.reportingdata.Section} from a {@link Section}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.reportingdata.Section(this.getIid(), cache, uri);
    }
}
