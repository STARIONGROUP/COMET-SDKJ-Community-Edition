...
/**
 * A Data Transfer Object representation of the {@link "AndExpression"} class.
 */
...
public class AndExpression extends BooleanExpression implements Cloneable {
    /**
     * Initializes a new instance of the {@link "AndExpression"} class.
     */
     ...
     */
    public AndExpression(UUID iid, int rev) {
        super(iid, rev);
        this.term = new ArrayList<UUID>();
    }
    ...
    /**
     * Gets the route for the current {@link AndExpression}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.AndExpression} from a {@link AndExpression}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.AndExpression(this.getIid(), cache, uri);
    }
}
