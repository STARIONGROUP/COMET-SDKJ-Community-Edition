...
public class NotExpression extends BooleanExpression implements Cloneable {
     ...
     */
    public NotExpression(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * The unique identifier of the referenced term.
     */
    ...
    /**
     * Gets the route for the current {@link NotExpression}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.NotExpression} from a {@link NotExpression}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.NotExpression(this.getIid(), cache, uri);
    }
}
