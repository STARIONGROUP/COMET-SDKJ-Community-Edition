...
public class CyclicRatioScale extends RatioScale implements Cloneable {
     ...
     */
    public CyclicRatioScale(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * Gets the route for the current {@link CyclicRatioScale}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.CyclicRatioScale} from a {@link CyclicRatioScale}
     *
    ...
    {
        return new cdp4common.sitedirectorydata.CyclicRatioScale(this.getIid(), cache, uri);
    }
}
