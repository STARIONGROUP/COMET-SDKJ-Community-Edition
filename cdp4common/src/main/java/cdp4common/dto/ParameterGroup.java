...
public class ParameterGroup extends Thing implements Cloneable, NamedThing {
     ...
     */
    public ParameterGroup(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * The unique identifier of the referenced containingGroup.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = true, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID containingGroup;
    ...
    /**
     * Gets the route for the current {@link ParameterGroup}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.ParameterGroup} from a {@link ParameterGroup}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.ParameterGroup(this.getIid(), cache, uri);
    }
}
