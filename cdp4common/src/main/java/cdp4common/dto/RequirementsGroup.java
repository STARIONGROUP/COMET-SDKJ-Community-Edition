...
public class RequirementsGroup extends RequirementsContainer implements Cloneable {
     ...
     */
    public RequirementsGroup(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link RequirementsGroup}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.RequirementsGroup} from a {@link RequirementsGroup}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.RequirementsGroup(this.getIid(), cache, uri);
    }
}
