...
public class DomainFileStore extends FileStore implements Cloneable {
     ...
     */
    public DomainFileStore(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * Gets the route for the current {@link DomainFileStore}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.DomainFileStore} from a {@link DomainFileStore}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.DomainFileStore(this.getIid(), cache, uri);
    }
}
