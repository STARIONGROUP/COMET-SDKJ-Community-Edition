...
public class RelationshipParameterValue extends ParameterValue implements Cloneable {
     ...
     */
    public RelationshipParameterValue(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link RelationshipParameterValue}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.RelationshipParameterValue} from a {@link RelationshipParameterValue}
     *
    ...
    {
        return new cdp4common.engineeringmodeldata.RelationshipParameterValue(this.getIid(), cache, uri);
    }
}
