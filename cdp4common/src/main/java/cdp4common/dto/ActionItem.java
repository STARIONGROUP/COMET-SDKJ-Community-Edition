...
public class ActionItem extends ModellingAnnotationItem implements Cloneable {
     ...
     */
    public ActionItem(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * The unique identifier of the referenced actionee.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID actionee;
    ...
    /**
     * Instantiate a {@link cdp4common.reportingdata.ActionItem} from a {@link ActionItem}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.reportingdata.ActionItem(this.getIid(), cache, uri);
    }
}
