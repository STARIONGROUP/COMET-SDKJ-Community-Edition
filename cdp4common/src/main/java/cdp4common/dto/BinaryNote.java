...
public class BinaryNote extends Note implements Cloneable {
     ...
     */
    public BinaryNote(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * The unique identifier of the referenced fileType.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID fileType;

    /**
     * Gets the route for the current {@link BinaryNote}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.reportingdata.BinaryNote} from a {@link BinaryNote}
     *
    ...
    {
        return new cdp4common.reportingdata.BinaryNote(this.getIid(), cache, uri);
    }
}
