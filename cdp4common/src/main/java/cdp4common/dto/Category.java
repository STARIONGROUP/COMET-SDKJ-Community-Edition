...
public class Category extends DefinedThing implements Cloneable, DeprecatableThing {
    ...
    public Category()
    {
        ...
        this.superCategory = new ArrayList<UUID>();
    }
     ...
     */
    public Category(UUID iid, int rev) {
        super(iid, rev);
        this.permissibleClass = new ArrayList<ClassKind>();
        this.superCategory = new ArrayList<UUID>();
    }
    ...
    /**
     * The list of unique identifiers of the referenced superCategory instances.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private ArrayList<UUID> superCategory;

    /**
     * Gets the route for the current {@link Category}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.Category} from a {@link Category}
     *
    ...
    {
        return new cdp4common.sitedirectorydata.Category(this.getIid(), cache, uri);
    }
}
