...
/**
 * A Data Transfer Object representation of the {@link SiteDirectoryDataDiscussionItem} class.
 */
...
public class SiteDirectoryDataDiscussionItem extends DiscussionItem implements Cloneable {
     ...
     */
    public SiteDirectoryDataDiscussionItem(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * Gets the route for the current {@link SiteDirectoryDataDiscussionItem}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.reportingdata.SiteDirectoryDataDiscussionItem} from a {@link SiteDirectoryDataDiscussionItem}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.reportingdata.SiteDirectoryDataDiscussionItem(this.getIid(), cache, uri);
    }
}
