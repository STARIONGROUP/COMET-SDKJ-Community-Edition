...
public class OwnedStyle extends DiagrammingStyle implements Cloneable {
     ...
     */
    public OwnedStyle(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link OwnedStyle}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.diagramdata.OwnedStyle} from a {@link OwnedStyle}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.diagramdata.OwnedStyle(this.getIid(), cache, uri);
    }
}
