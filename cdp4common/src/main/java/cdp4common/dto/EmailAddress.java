...
public class EmailAddress extends Thing implements Cloneable {
     ...
     */
    public EmailAddress(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * Gets the route for the current {@link EmailAddress}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.EmailAddress} from a {@link EmailAddress}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.sitedirectorydata.EmailAddress(this.getIid(), cache, uri);
    }
}
