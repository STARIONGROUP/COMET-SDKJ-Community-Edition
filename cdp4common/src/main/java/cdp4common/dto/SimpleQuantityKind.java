...
/**
 * A Data Transfer Object representation of the {@link SimpleQuantityKind} class.
 */
...
public class SimpleQuantityKind extends QuantityKind implements Cloneable {
     ...
     */
    public SimpleQuantityKind(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link SimpleQuantityKind}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.SimpleQuantityKind} from a {@link SimpleQuantityKind}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.sitedirectorydata.SimpleQuantityKind(this.getIid(), cache, uri);
    }
}
