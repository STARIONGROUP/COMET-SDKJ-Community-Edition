...
public class EnumerationValueDefinition extends DefinedThing implements Cloneable {
     ...
     */
    public EnumerationValueDefinition(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link EnumerationValueDefinition}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.EnumerationValueDefinition} from a {@link EnumerationValueDefinition}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.sitedirectorydata.EnumerationValueDefinition(this.getIid(), cache, uri);
    }
}
