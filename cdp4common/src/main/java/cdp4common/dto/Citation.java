...
public class Citation extends Thing implements Cloneable, ShortNamedThing {
     ...
     */
    public Citation(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * Gets the route for the current {@link Citation}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.commondata.Citation} from a {@link Citation}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.commondata.Citation(this.getIid(), cache, uri);
    }
}
