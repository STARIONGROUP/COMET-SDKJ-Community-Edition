...
public class QuantityKindFactor extends Thing implements Cloneable {
     ...
     */
    public QuantityKindFactor(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * The unique identifier of the referenced quantityKind.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID quantityKind;

    /**
     * Gets the route for the current {@link QuantityKindFactor}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.QuantityKindFactor} from a {@link QuantityKindFactor}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.sitedirectorydata.QuantityKindFactor(this.getIid(), cache, uri);
    }
}
