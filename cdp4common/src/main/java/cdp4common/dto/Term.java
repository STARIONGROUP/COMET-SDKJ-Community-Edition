...
public class Term extends DefinedThing implements Cloneable, DeprecatableThing {
    ...
    /**
     * Gets the route for the current {@link Term}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.Term} from a {@link Term}
     *
    ...
    {
        return new cdp4common.sitedirectorydata.Term(this.getIid(), cache, uri);
    }
}
