...
/**
 * A Data Transfer Object representation of the {@link "ChangeRequest"} class.
 */
...
public class ChangeRequest extends ContractDeviation implements Cloneable {
     ...
     */
    public ChangeRequest(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link ChangeRequest}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.reportingdata.ChangeRequest} from a {@link ChangeRequest}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.reportingdata.ChangeRequest(this.getIid(), cache, uri);
    }
}
