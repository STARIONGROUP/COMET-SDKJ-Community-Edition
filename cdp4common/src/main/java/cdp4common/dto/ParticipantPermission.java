...
/**
 * A Data Transfer Object representation of the {@link ParticipantPermission} class.
 */
...
public class ParticipantPermission extends Thing implements Cloneable, DeprecatableThing {
     ...
     */
    public ParticipantPermission(UUID iid, int rev) {
        super(iid, rev);
    }
    ...
    /**
     * Gets the route for the current {@link ParticipantPermission}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.ParticipantPermission} from a {@link ParticipantPermission}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.sitedirectorydata.ParticipantPermission(this.getIid(), cache, uri);
    }
}
