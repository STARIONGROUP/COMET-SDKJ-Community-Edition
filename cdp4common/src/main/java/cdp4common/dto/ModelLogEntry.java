...
public class ModelLogEntry extends Thing implements Cloneable, Annotation, CategorizableThing, LogEntry, TimeStampedThing {
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.ModelLogEntry} from a {@link ModelLogEntry}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.ModelLogEntry(this.getIid(), cache, uri);
    }
}
