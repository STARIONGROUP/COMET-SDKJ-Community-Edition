...
public class IntervalScale extends MeasurementScale implements Cloneable {
     ...
     */
    public IntervalScale(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link IntervalScale}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.sitedirectorydata.IntervalScale} from a {@link IntervalScale}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.sitedirectorydata.IntervalScale(this.getIid(), cache, uri);
    }
}
