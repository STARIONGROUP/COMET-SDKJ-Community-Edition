...
public class Requirement extends SimpleParameterizableThing implements Cloneable, CategorizableThing, DeprecatableThing {
    ...
    public Requirement() {
        ...
        this.parametricConstraint = new ArrayList<OrderedItem>();
    }
     ...
     */
    public Requirement(UUID iid, int rev) {
        super(iid, rev);
        this.category = new ArrayList<UUID>();
        this.parametricConstraint = new ArrayList<OrderedItem>();
    }
    ...
    /**
     * The unique identifiers of the contained parametricConstraint instances.
     */
    @UmlInformation(aggregation = AggregationKind.COMPOSITE, isDerived = false, isOrdered = true, isNullable = false, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private ArrayList<OrderedItem> parametricConstraint;

    /**
     * Gets the route for the current {@link Requirement}.
     */
    @Override
    ...
    public List<List> getContainerLists() {
        ...
        containers.add(this.getParametricConstraint());
        return containers;
    }

    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.Requirement} from a {@link Requirement}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.Requirement(this.getIid(), cache, uri);
    }
}
