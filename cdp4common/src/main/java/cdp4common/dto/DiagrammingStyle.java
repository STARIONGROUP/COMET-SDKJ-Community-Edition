...
/**
 * A Data Transfer Object representation of the {@link "DiagrammingStyle"} class.
 */
...
public abstract class DiagrammingStyle extends DiagramThingBase implements Cloneable {
    ...
    protected DiagrammingStyle() {
        this.usedColor = new ArrayList<UUID>();
    }
     ...
     */
    protected DiagrammingStyle(UUID iid, int rev) {
        super(iid, rev);
        this.usedColor = new ArrayList<UUID>();
    }

    /**
     * The unique identifier of the referenced fillColor.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = true, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID fillColor;
    ...
    /**
     * The unique identifier of the referenced fontColor.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = true, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID fontColor;
    ...
    /**
     * The unique identifier of the referenced strokeColor.
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = true, isPersistent = true)
    @DataMember
    @Getter
    @Setter
    private UUID strokeColor;
    ...
    /**
     * The unique identifiers of the contained usedColor instances.
     */
    ...
    public List<List> getContainerLists() {
        ...
        containers.add(this.getUsedColor());
        return containers;
    }
}
