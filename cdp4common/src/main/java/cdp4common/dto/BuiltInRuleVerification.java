...
public class BuiltInRuleVerification extends RuleVerification implements Cloneable {
     ...
     */
    public BuiltInRuleVerification(UUID iid, int rev) {
        super(iid, rev);
    }

    /**
     * Gets the route for the current {@link BuiltInRuleVerification}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.BuiltInRuleVerification} from a {@link BuiltInRuleVerification}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.BuiltInRuleVerification(this.getIid(), cache, uri);
    }
}
