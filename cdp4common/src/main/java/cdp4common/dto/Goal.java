...
public class Goal extends DefinedThing implements Cloneable, CategorizableThing {
    ...
    /**
     * Gets the route for the current {@link Goal}.
     */
    @Override
    ...
    /**
     * Instantiate a {@link cdp4common.engineeringmodeldata.Goal} from a {@link Goal}
     *
    ...
    public cdp4common.commondata.Thing instantiatePojo(Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
        return new cdp4common.engineeringmodeldata.Goal(this.getIid(), cache, uri);
    }
}
