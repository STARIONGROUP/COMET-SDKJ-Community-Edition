...
public  abstract class DiagrammingStyle extends DiagramThingBase implements Cloneable {
     ...
     */
    protected DiagrammingStyle(UUID iid, Cache<Pair<UUID, UUID>, Thing> cache, URI iDalUri) {
        this.usedColor = new ContainerList<Color>(this);
    }
    ...
    /**
     * Gets an {@link List<List<Thing>>} that references the composite properties of the current {@link DiagrammingStyle}.
     */
    @Override
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>DiagrammingStyle}.
     *
