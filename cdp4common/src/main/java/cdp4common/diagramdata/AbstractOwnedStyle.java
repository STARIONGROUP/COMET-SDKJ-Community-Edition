...
public abstract class AbstractOwnedStyle extends AbstractDiagrammingStyle  {
    /**
    ...
    /**
     * Initializes a new instance of the <code>OwnedStyle<code/> class.
     *
     * @see OwnedStyle
     */
    public AbstractOwnedStyle() {
    }
     ...
     * @see OwnedStyle
     */
    public AbstractOwnedStyle(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this <code>OwnedStyle<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>OwnedStyle<code/>.
     *
     * @see OwnedStyle
     * @see Thing
     */
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        OwnedStyle clone = (OwnedStyle)this.clone();
     ...
     */
    @Override
    public OwnedStyle clone(boolean cloneContainedThings) throws CloneNotSupportedException {
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>OwnedStyle<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>OwnedStyle<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>OwnedStyle<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.OwnedStyle dto = new cdp4common.dto.OwnedStyle(this.iid, this.revisionNumber);
