...
public abstract class AbstractDiagrammingStyle extends AbstractDiagramThingBase  {
    /**
     ...
     */
    protected AbstractDiagrammingStyle() {
     ...
     * @see DiagrammingStyle
     */
    protected AbstractDiagrammingStyle(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.usedColor = new ContainerList<Color>(this);
    }
