...
public abstract class AbstractDiagramElementThing extends AbstractDiagramElementContainer  {
    /**
     ...
     */
    protected AbstractDiagramElementThing() {
     ...
     * @see DiagramElementThing
     */
    protected AbstractDiagramElementThing(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.localStyle = new ContainerList<OwnedStyle>(this);
    }
