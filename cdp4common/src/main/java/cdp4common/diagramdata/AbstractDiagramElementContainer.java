...
public abstract class AbstractDiagramElementContainer extends AbstractDiagramThingBase  {
    /**
     ...
     */
    protected AbstractDiagramElementContainer() {
     ...
     * @see DiagramElementContainer
     */
    protected AbstractDiagramElementContainer(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.bounds = new ContainerList<Bounds>(this);
        this.diagramElement = new ContainerList<DiagramElementThing>(this);
    }
