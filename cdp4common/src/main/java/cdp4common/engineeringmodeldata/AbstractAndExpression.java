...
public abstract class AbstractAndExpression extends AbstractBooleanExpression  {
    /**
     ...
     * @see AndExpression
     */
    public AbstractAndExpression(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.term = new List<BooleanExpression>();
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.AndExpression dto = new cdp4common.dto.AndExpression(this.iid, this.revisionNumber);
