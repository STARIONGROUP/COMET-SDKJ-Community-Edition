...
public class AndExpression extends BooleanExpression implements Cloneable {
     ...
     */
    public AndExpression(UUID iid, Cache<CacheKey, Thing> cache, URI iDalUri) {
    ...
    /**
     * Resolve the properties of the current {@link AndExpression} from its {@link cdp4common.dto.Thing} counter-part
     *
    ...
    /**
     * Generates a {@link cdp4common.dto.Thing} from the current {@link AndExpression}
     *
