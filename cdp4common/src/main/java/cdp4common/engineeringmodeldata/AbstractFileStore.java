 ...
 */
public abstract class AbstractFileStore extends AbstractThing implements NamedThing, OwnedThing, TimeStampedThing {
    /**
     ...
     * @see FileStore
     */
    protected AbstractFileStore(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.file = new ContainerList<File>(this);
        this.folder = new ContainerList<Folder>(this);
    }
