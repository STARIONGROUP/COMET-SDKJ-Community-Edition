 ...
 */
public abstract class AbstractParameterBase extends AbstractThing implements OwnedThing {
    /**
     ...
     * @see ParameterBase
     */
    protected AbstractParameterBase() {
    }
     ...
     * @see ParameterBase
     */
    protected AbstractParameterBase(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
