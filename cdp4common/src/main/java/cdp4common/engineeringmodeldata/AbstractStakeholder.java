...
public abstract class AbstractStakeholder extends AbstractDefinedThing implements CategorizableThing {
    /**
     ...
     * @see Stakeholder
     */
    public AbstractStakeholder(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
        this.stakeholderValue = new List<StakeholderValue>();
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Stakeholder dto = new cdp4common.dto.Stakeholder(this.iid, this.revisionNumber);
