...
public class RequirementsGroup extends AbstractRequirementsGroup {
    /**
     ...
     * @see RequirementsGroup
     */
    public RequirementsGroup(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
