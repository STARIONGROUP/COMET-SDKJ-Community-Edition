...
public  class RequirementsGroup extends RequirementsContainer implements Cloneable {
     ...
     */
    public RequirementsGroup(UUID iid, Cache<Pair<UUID, UUID>, Thing> cache, URI iDalUri) {
    }
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>RequirementsGroup}.
     *
