 ...
 */
public abstract class AbstractParameterOrOverrideBase extends AbstractParameterBase  {
    /**
     ...
     */
    protected AbstractParameterOrOverrideBase() {
     ...
     * @see ParameterOrOverrideBase
     */
    protected AbstractParameterOrOverrideBase(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.parameterSubscription = new ContainerList<ParameterSubscription>(this);
    }
