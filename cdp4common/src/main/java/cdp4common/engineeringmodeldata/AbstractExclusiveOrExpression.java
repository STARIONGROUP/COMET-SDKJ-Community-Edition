...
public abstract class AbstractExclusiveOrExpression extends AbstractBooleanExpression  {
    /**
     ...
     */
    public AbstractExclusiveOrExpression() {
     ...
     * @see ExclusiveOrExpression
     */
    public AbstractExclusiveOrExpression(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.term = new List<BooleanExpression>();
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ExclusiveOrExpression dto = new cdp4common.dto.ExclusiveOrExpression(this.iid, this.revisionNumber);
