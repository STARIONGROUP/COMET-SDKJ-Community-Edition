...
public abstract class FileStore extends Thing implements Cloneable, NamedThing, OwnedThing, TimeStampedThing {
    ...
    /**
     * Gets an {@link List<List>} that references the composite properties of the current {@link FileStore}.
     */
    @Override
    ...
    /**
     * Validates the cardinalities of the properties of this FileStore}.
     *
