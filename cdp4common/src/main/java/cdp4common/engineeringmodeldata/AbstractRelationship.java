...
public abstract class AbstractRelationship extends AbstractThing implements CategorizableThing, OwnedThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>Relationship<code/> class.
     *
     * @see Relationship
     */
     ...
     * @see Relationship
     */
    protected AbstractRelationship(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
        this.parameterValue = new ContainerList<RelationshipParameterValue>(this);
    }
    ...
    /**
     * <code>IEnumerable{IEnumerable}<code/> that references the composite properties of the current <code>Relationship<code/>.
     *
     * @see Iterable
     * @see Relationship
     */
    ...
    /**
     * Gets an <code>Iterable<Iterable><code/> that references the composite properties of the current <code>Relationship<code/>.
     *
     * @see Iterable
     * @see Relationship
     */
    ...
    /**
     * Creates and returns a copy of this <code>Relationship<code/> for edit purpose.
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>Relationship<code/>.
     * 
     * @see Relationship
     */
    @Override
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>Relationship<code/>.
     *
