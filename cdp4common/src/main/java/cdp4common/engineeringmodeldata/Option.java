...
public class Option extends DefinedThing implements Cloneable, CategorizableThing {
     ...
     */
    public Option(UUID iid, Cache<CacheKey, Thing> cache, URI iDalUri) {
    ...
    /**
     * {@link Iterable} that references the composite properties of the current {@link Option}.
     */
    private Iterable<Iterable> containerLists;

    /**
     * Gets a {@link Collection} that references the composite properties of the current {@link Option}.
     */
    @Override
    ...
    protected Thing genericClone(boolean cloneContainedThings) {
        ...
        clone.setNestedElement(cloneContainedThings ? new ContainerList<NestedElement>(clone) : new ContainerList<NestedElement>(this.getNestedElement(), clone, false));
    ...
    /**
     * Validates the cardinalities of the properties of this Option}.
     *
    ...
    /*
     * Gets a value indicating whether this {@link Option} is the default in the current {@link Iteration}
     */
