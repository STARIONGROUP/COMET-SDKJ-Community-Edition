...
public abstract class AbstractSimpleParameterValue extends AbstractThing implements OwnedThing {
    /**
     ...
     */
    public AbstractSimpleParameterValue() {
     ...
     * @see SimpleParameterValue
     */
    public AbstractSimpleParameterValue(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.value = new ValueArray<String>(this);
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.SimpleParameterValue dto = new cdp4common.dto.SimpleParameterValue(this.iid, this.revisionNumber);
