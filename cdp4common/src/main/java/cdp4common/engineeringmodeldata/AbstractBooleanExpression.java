...
public abstract class AbstractBooleanExpression extends AbstractThing  {
    /**
     ...
     * @see BooleanExpression
     */
    protected AbstractBooleanExpression(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
