 ...
 */
public abstract class AbstractSimpleParameterizableThing extends AbstractDefinedThing implements OwnedThing {
    /**
     ...
     */
    protected AbstractSimpleParameterizableThing() {
     ...
     * @see SimpleParameterizableThing
     */
    protected AbstractSimpleParameterizableThing(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.parameterValue = new ContainerList<SimpleParameterValue>(this);
    }
