...
public abstract class AbstractNestedParameter extends AbstractThing implements OwnedThing, VolatileThing {
    /**
     ...
     * @see NestedParameter
     */
    public AbstractNestedParameter() {
    }
     ...
     * @see NestedParameter
     */
    public AbstractNestedParameter(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    protected Iterable<String> validatePocoCardinality() {
        ...
        if (this.actualValue.trim().isEmpty()) {
            errorList.add("The property actualValue is null or empty.");
        }

        if (this.associatedParameter == null || this.associatedParameter.getIid().equals(new UUID(0L, 0L))) {
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.actualValue = dto.getActualValue();
        this.associatedParameter = this.cache.get<ParameterBase>(dto.getAssociatedParameter(), dto.getIterationContainerId()) ?? SentinelThingProvider.getSentinel<ParameterBase>();
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.NestedParameter dto = new cdp4common.dto.NestedParameter(this.iid, this.revisionNumber);

        dto.setActualState(this.actualState != null ? (UUID)this.actualState.getIid() : null);
        dto.setActualValue(this.actualValue);
        dto.setAssociatedParameter(this.associatedParameter != null ? this.associatedParameter.getIid() : new UUID(0L, 0L));
        dto.getExcludedDomain().add(this.excludedDomain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedPerson().add(this.excludedPerson.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setFormula(this.formula);
