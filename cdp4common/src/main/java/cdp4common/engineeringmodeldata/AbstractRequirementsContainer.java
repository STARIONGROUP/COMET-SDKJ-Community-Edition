 ...
 */
public abstract class AbstractRequirementsContainer extends AbstractDefinedThing implements CategorizableThing, OwnedThing {
    /**
     ...
     */
    protected AbstractRequirementsContainer() {
     ...
     * @see RequirementsContainer
     */
    protected AbstractRequirementsContainer(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
        this.group = new ContainerList<RequirementsGroup>(this);
        this.parameterValue = new ContainerList<RequirementsContainerParameterValue>(this);
    }
