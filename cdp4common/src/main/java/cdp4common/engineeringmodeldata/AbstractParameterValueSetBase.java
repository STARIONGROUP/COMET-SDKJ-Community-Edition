 ...
 */
public abstract class AbstractParameterValueSetBase extends AbstractThing implements OwnedThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>ParameterValueSetBase<code/> class.
     *
     * @see ParameterValueSetBase
     */
    protected AbstractParameterValueSetBase() {
     ...
     * @see ParameterValueSetBase
     */
    protected AbstractParameterValueSetBase(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.computed = new ValueArray<String>(this);
        this.formula = new ValueArray<String>(this);
        this.manual = new ValueArray<String>(this);
        this.published = new ValueArray<String>(this);
    ...
    /**
     * Creates and returns a copy of this <code>ParameterValueSetBase<code/> for edit purpose.
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>ParameterValueSetBase<code/>.
     * 
     * @see ParameterValueSetBase
     */
    @Override
    public ParameterValueSetBase clone(boolean cloneContainedThings) throws CloneNotSupportedException {
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>ParameterValueSetBase<code/>.
     *
