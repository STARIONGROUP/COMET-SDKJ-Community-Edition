...
public abstract class AbstractParameterGroup extends AbstractThing implements NamedThing {
    /**
     ...
     * @see ParameterGroup
     */
    public AbstractParameterGroup(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.containingGroup = (dto.getContainingGroup() != null) ? this.cache.get<ParameterGroup>(dto.getContainingGroup.getValue(), dto.getIterationContainerId()) : null;
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ParameterGroup dto = new cdp4common.dto.ParameterGroup(this.iid, this.revisionNumber);

        dto.setContainingGroup(this.containingGroup != null ? (UUID)this.containingGroup.getIid() : null);
