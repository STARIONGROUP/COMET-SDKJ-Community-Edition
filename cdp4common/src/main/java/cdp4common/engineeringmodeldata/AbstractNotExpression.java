...
public abstract class AbstractNotExpression extends AbstractBooleanExpression  {
    /**
     ...
     * @see NotExpression
     */
    public AbstractNotExpression(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    protected Iterable<String> validatePocoCardinality() {
        ...
        if (this.term == null || this.term.getIid().equals(new UUID(0L, 0L))) {
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.term = this.cache.get<BooleanExpression>(dto.getTerm(), dto.getIterationContainerId()) ?? SentinelThingProvider.getSentinel<BooleanExpression>();
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.NotExpression dto = new cdp4common.dto.NotExpression(this.iid, this.revisionNumber);

        dto.getExcludedDomain().add(this.excludedDomain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedPerson().add(this.excludedPerson.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setModifiedOn(this.modifiedOn);
        dto.setRevisionNumber(this.revisionNumber);
        dto.setTerm(this.term != null ? this.term.getIid() : new UUID(0L, 0L));
