...
public abstract class AbstractValueGroup extends AbstractDefinedThing implements CategorizableThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>ValueGroup<code/> class.
     *
     * @see ValueGroup
     */
    public AbstractValueGroup() {
     ...
     * @see ValueGroup
     */
    public AbstractValueGroup(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
    }
    ...
    /**
     * Creates and returns a copy of this <code>ValueGroup<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>ValueGroup<code/>.
     *
     * @see ValueGroup
     * @see Thing
     */
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ValueGroup clone = (ValueGroup)this.clone();
     ...
     */
    @Override
    public ValueGroup clone(boolean cloneContainedThings) throws CloneNotSupportedException {
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>ValueGroup<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>ValueGroup<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.ValueGroup dto = (cdp4common.dto.ValueGroup)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>ValueGroup<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ValueGroup dto = new cdp4common.dto.ValueGroup(this.iid, this.revisionNumber);
