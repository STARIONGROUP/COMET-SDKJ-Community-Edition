...
public abstract class AbstractRelationalExpression extends AbstractBooleanExpression  {
    /**
     ...
     */
    public AbstractRelationalExpression() {
     ...
     * @see RelationalExpression
     */
    public AbstractRelationalExpression(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.value = new ValueArray<String>(this);
    }
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.relationalOperator = dto.getRelationalOperator();
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.RelationalExpression dto = new cdp4common.dto.RelationalExpression(this.iid, this.revisionNumber);
        ...
        dto.setRelationalOperator(this.relationalOperator);
