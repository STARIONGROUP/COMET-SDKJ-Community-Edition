...
@ToString
@EqualsAndHashCode
public  abstract class ParameterValueSetBase extends Thing implements OwnedThing {
    /**
     ...
     * @see ParameterValueSetBase
     */
    protected ParameterValueSetBase(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.computed = new ValueArray<String>(this);
        this.formula = new ValueArray<String>(this);
        this.manual = new ValueArray<String>(this);
        this.published = new ValueArray<String>(this);
