...
public abstract class AbstractIteration extends AbstractThing  {
    /**
     ...
     * @see Iteration
     */
    public AbstractIteration(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.actualFiniteStateList = new ContainerList<ActualFiniteStateList>(this);
        this.diagramCanvas = new ContainerList<DiagramCanvas>(this);
        this.domainFileStore = new ContainerList<DomainFileStore>(this);
        this.element = new ContainerList<ElementDefinition>(this);
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setActualFiniteStateList(cloneContainedThings ? new ContainerList<ActualFiniteStateList>(clone) : new ContainerList<ActualFiniteStateList>(this.actualFiniteStateList, clone));
        clone.setDiagramCanvas(cloneContainedThings ? new ContainerList<DiagramCanvas>(clone) : new ContainerList<DiagramCanvas>(this.diagramCanvas, clone));
        clone.setDomainFileStore(cloneContainedThings ? new ContainerList<DomainFileStore>(clone) : new ContainerList<DomainFileStore>(this.domainFileStore, clone));
        clone.setElement(cloneContainedThings ? new ContainerList<ElementDefinition>(clone) : new ContainerList<ElementDefinition>(this.element, clone));
        clone.setExcludedDomain(new List<DomainOfExpertise>(this.excludedDomain));
        clone.setExcludedPerson(new List<Person>(this.excludedPerson));
        clone.setExternalIdentifierMap(cloneContainedThings ? new ContainerList<ExternalIdentifierMap>(clone) : new ContainerList<ExternalIdentifierMap>(this.externalIdentifierMap, clone));
        clone.setGoal(cloneContainedThings ? new ContainerList<Goal>(clone) : new ContainerList<Goal>(this.goal, clone));
        clone.setOption(cloneContainedThings ? new OrderedItemList<Option>(clone, true) : new OrderedItemList<Option>(this.option, clone));
        clone.setPossibleFiniteStateList(cloneContainedThings ? new ContainerList<PossibleFiniteStateList>(clone) : new ContainerList<PossibleFiniteStateList>(this.possibleFiniteStateList, clone));
        clone.setPublication(cloneContainedThings ? new ContainerList<Publication>(clone) : new ContainerList<Publication>(this.publication, clone));
        clone.setRelationship(cloneContainedThings ? new ContainerList<Relationship>(clone) : new ContainerList<Relationship>(this.relationship, clone));
        clone.setRequirementsSpecification(cloneContainedThings ? new ContainerList<RequirementsSpecification>(clone) : new ContainerList<RequirementsSpecification>(this.requirementsSpecification, clone));
        clone.setRuleVerificationList(cloneContainedThings ? new ContainerList<RuleVerificationList>(clone) : new ContainerList<RuleVerificationList>(this.ruleVerificationList, clone));
        clone.setSharedDiagramStyle(cloneContainedThings ? new ContainerList<SharedStyle>(clone) : new ContainerList<SharedStyle>(this.sharedDiagramStyle, clone));
        clone.setStakeholder(cloneContainedThings ? new ContainerList<Stakeholder>(clone) : new ContainerList<Stakeholder>(this.stakeholder, clone));
        clone.setStakeholderValue(cloneContainedThings ? new ContainerList<StakeholderValue>(clone) : new ContainerList<StakeholderValue>(this.stakeholderValue, clone));
        clone.setStakeholderValueMap(cloneContainedThings ? new ContainerList<StakeHolderValueMap>(clone) : new ContainerList<StakeHolderValueMap>(this.stakeholderValueMap, clone));
        clone.setValueGroup(cloneContainedThings ? new ContainerList<ValueGroup>(clone) : new ContainerList<ValueGroup>(this.valueGroup, clone));

        if (cloneContainedThings) {
            clone.getActualFiniteStateList().addAll(this.actualFiniteStateList.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getDiagramCanvas().addAll(this.diagramCanvas.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getDomainFileStore().addAll(this.domainFileStore.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getElement().addAll(this.element.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getExternalIdentifierMap().addAll(this.externalIdentifierMap.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getGoal().addAll(this.goal.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getOption().addAll(this.option.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getPossibleFiniteStateList().addAll(this.possibleFiniteStateList.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getPublication().addAll(this.publication.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getRelationship().addAll(this.relationship.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getRequirementsSpecification().addAll(this.requirementsSpecification.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getRuleVerificationList().addAll(this.ruleVerificationList.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getSharedDiagramStyle().addAll(this.sharedDiagramStyle.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getStakeholder().addAll(this.stakeholder.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getStakeholderValue().addAll(this.stakeholderValue.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getStakeholderValueMap().addAll(this.stakeholderValueMap.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getValueGroup().addAll(this.valueGroup.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
        }
    ...
    protected Iterable<String> validatePocoCardinality() {
        ...
        if (this.iterationSetup == null || this.iterationSetup.getIid().equals(new UUID(0L, 0L))) {
        ...
        int optionCount = this.option.size();
        if (optionCount < 1) {
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.actualFiniteStateList.resolveList(dto.getActualFiniteStateList(), dto.getIid(), this.cache);
        this.defaultOption = (dto.getDefaultOption() != null) ? this.cache.get<Option>(dto.getDefaultOption.getValue(), dto.getIid()) : null;
        this.diagramCanvas.resolveList(dto.getDiagramCanvas(), dto.getIid(), this.cache);
        this.domainFileStore.resolveList(dto.getDomainFileStore(), dto.getIid(), this.cache);
        this.element.resolveList(dto.getElement(), dto.getIid(), this.cache);
        this.excludedDomain.resolveList(dto.getExcludedDomain(), dto.getIid(), this.cache);
        this.excludedPerson.resolveList(dto.getExcludedPerson(), dto.getIid(), this.cache);
        this.externalIdentifierMap.resolveList(dto.getExternalIdentifierMap(), dto.getIid(), this.cache);
        this.goal.resolveList(dto.getGoal(), dto.getIid(), this.cache);
        this.iterationSetup = this.cache.get<IterationSetup>(dto.getIterationSetup(), dto.getIid()) ?? SentinelThingProvider.getSentinel<IterationSetup>();
        this.modifiedOn = dto.getModifiedOn();
        this.option.resolveList(dto.getOption(), dto.getIid(), this.cache);
        this.possibleFiniteStateList.resolveList(dto.getPossibleFiniteStateList(), dto.getIid(), this.cache);
        this.publication.resolveList(dto.getPublication(), dto.getIid(), this.cache);
        this.relationship.resolveList(dto.getRelationship(), dto.getIid(), this.cache);
        this.requirementsSpecification.resolveList(dto.getRequirementsSpecification(), dto.getIid(), this.cache);
        this.revisionNumber = dto.getRevisionNumber();
        this.ruleVerificationList.resolveList(dto.getRuleVerificationList(), dto.getIid(), this.cache);
        this.sharedDiagramStyle.resolveList(dto.getSharedDiagramStyle(), dto.getIid(), this.cache);
        this.sourceIterationIid = dto.getSourceIterationIid();
        this.stakeholder.resolveList(dto.getStakeholder(), dto.getIid(), this.cache);
        this.stakeholderValue.resolveList(dto.getStakeholderValue(), dto.getIid(), this.cache);
        this.stakeholderValueMap.resolveList(dto.getStakeholderValueMap(), dto.getIid(), this.cache);
        this.topElement = (dto.getTopElement() != null) ? this.cache.get<ElementDefinition>(dto.getTopElement.getValue(), dto.getIid()) : null;
        this.valueGroup.resolveList(dto.getValueGroup(), dto.getIid(), this.cache);
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Iteration dto = new cdp4common.dto.Iteration(this.iid, this.revisionNumber);

        dto.getActualFiniteStateList().add(this.actualFiniteStateList.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setDefaultOption(this.defaultOption != null ? (UUID)this.defaultOption.getIid() : null);
        dto.getDiagramCanvas().add(this.diagramCanvas.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getDomainFileStore().add(this.domainFileStore.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getElement().add(this.element.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedDomain().add(this.excludedDomain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedPerson().add(this.excludedPerson.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExternalIdentifierMap().add(this.externalIdentifierMap.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getGoal().add(this.goal.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setIterationSetup(this.iterationSetup != null ? this.iterationSetup.getIid() : new UUID(0L, 0L));
        dto.setModifiedOn(this.modifiedOn);
        dto.getOption().add(this.option.toDtoOrderedItemList());
        dto.getPossibleFiniteStateList().add(this.possibleFiniteStateList.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getPublication().add(this.publication.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getRelationship().add(this.relationship.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getRequirementsSpecification().add(this.requirementsSpecification.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setRevisionNumber(this.revisionNumber);
        dto.getRuleVerificationList().add(this.ruleVerificationList.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getSharedDiagramStyle().add(this.sharedDiagramStyle.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setSourceIterationIid(this.sourceIterationIid);
        dto.getStakeholder().add(this.stakeholder.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getStakeholderValue().add(this.stakeholderValue.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getStakeholderValueMap().add(this.stakeholderValueMap.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setTopElement(this.topElement != null ? (UUID)this.topElement.getIid() : null);
