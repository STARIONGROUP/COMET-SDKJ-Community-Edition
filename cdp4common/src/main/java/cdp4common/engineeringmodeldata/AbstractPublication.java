...
public abstract class AbstractPublication extends AbstractThing implements TimeStampedThing {
    /**
     ...
     * @see Publication
     */
    public AbstractPublication(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.domain = new List<DomainOfExpertise>();
        this.publishedParameter = new List<ParameterOrOverrideBase>();
    }
     ...
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    private List<ParameterOrOverrideBase> publishedParameter;
     ...
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    public List<ParameterOrOverrideBase> getPublishedParameter(){
     ...
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
     public void setPublishedParameter(List<ParameterOrOverrideBase> publishedParameter){
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setPublishedParameter(new List<ParameterOrOverrideBase>(this.publishedParameter));
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.publishedParameter.resolveList(dto.getPublishedParameter(), dto.getIterationContainerId(), this.cache);
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Publication dto = new cdp4common.dto.Publication(this.iid, this.revisionNumber);
        ...
        dto.getPublishedParameter().add(this.publishedParameter.stream().map(x -> x.Iid).collect(Collectors.toList()));
