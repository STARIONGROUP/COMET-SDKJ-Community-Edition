...
public abstract class AbstractParameterOverride extends AbstractParameterOrOverrideBase  {
    /**
     ...
     */
    public AbstractParameterOverride() {
     ...
     * @see ParameterOverride
     */
    public AbstractParameterOverride(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.valueSet = new ContainerList<ParameterOverrideValueSet>(this);
    }
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setValueSet(cloneContainedThings ? new ContainerList<ParameterOverrideValueSet>(clone) : new ContainerList<ParameterOverrideValueSet>(this.valueSet, clone));
    ...
    protected Iterable<String> validatePocoCardinality() {
        ...
        if (this.parameter == null || this.parameter.getIid().equals(new UUID(0L, 0L))) {
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.parameter = this.cache.get<Parameter>(dto.getParameter(), dto.getIterationContainerId()) ?? SentinelThingProvider.getSentinel<Parameter>();
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ParameterOverride dto = new cdp4common.dto.ParameterOverride(this.iid, this.revisionNumber);

        dto.getExcludedDomain().add(this.excludedDomain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedPerson().add(this.excludedPerson.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setModifiedOn(this.modifiedOn);
        dto.setOwner(this.owner != null ? this.owner.getIid() : new UUID(0L, 0L));
        dto.setParameter(this.parameter != null ? this.parameter.getIid() : new UUID(0L, 0L));
