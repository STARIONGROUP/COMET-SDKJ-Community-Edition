...
public abstract class AbstractGoal extends AbstractDefinedThing implements CategorizableThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>Goal<code/> class.
     *
     * @see Goal
     */
    public AbstractGoal() {
     ...
     * @see Goal
     */
    public AbstractGoal(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
    }
    ...
    /**
     * Creates and returns a copy of this <code>Goal<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>Goal<code/>.
     *
     * @see Goal
     * @see Thing
     */
     ...
     */
    @Override
    public Goal clone(boolean cloneContainedThings) throws CloneNotSupportedException {
        this.setChangeKind(ChangeKind.UPDATE);

        return (Goal)this.genericClone(cloneContainedThings);
    }

    /**
     * Validates the cardinalities of the properties of this <clone>Goal<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>Goal<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.Goal dto = (cdp4common.dto.Goal)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>Goal<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Goal dto = new cdp4common.dto.Goal(this.iid, this.revisionNumber);
