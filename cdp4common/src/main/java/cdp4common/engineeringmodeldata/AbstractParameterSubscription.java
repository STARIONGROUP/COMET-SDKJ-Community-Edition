...
public abstract class AbstractParameterSubscription extends AbstractParameterBase  {
    /**
     ...
     */
    public AbstractParameterSubscription() {
     ...
     * @see ParameterSubscription
     */
    public AbstractParameterSubscription(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.valueSet = new ContainerList<ParameterSubscriptionValueSet>(this);
    }
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setValueSet(cloneContainedThings ? new ContainerList<ParameterSubscriptionValueSet>(clone) : new ContainerList<ParameterSubscriptionValueSet>(this.valueSet, clone));
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ParameterSubscription dto = new cdp4common.dto.ParameterSubscription(this.iid, this.revisionNumber);
