/* --------------------------------------------------------------------------------------------------------------------
 * AbstractBooleanParameterType.java
...
public abstract class AbstractBooleanParameterType extends AbstractScalarParameterType  {
    /**
     ...
     */
    public AbstractBooleanParameterType() {
    }
     ...
     * @see BooleanParameterType
     */
    public AbstractBooleanParameterType(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this <code>BooleanParameterType<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>BooleanParameterType<code/>.
     *
     * @see BooleanParameterType
     * @see Thing
     */
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        BooleanParameterType clone = (BooleanParameterType)this.clone();
     ...
     */
    @Override
    public BooleanParameterType clone(boolean cloneContainedThings) throws CloneNotSupportedException {
        this.setChangeKind(ChangeKind.UPDATE);

        return (BooleanParameterType)this.genericClone(cloneContainedThings);
    }

    /**
     * Validates the cardinalities of the properties of this <clone>BooleanParameterType<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>BooleanParameterType<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.BooleanParameterType dto = (cdp4common.dto.BooleanParameterType)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>BooleanParameterType<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.BooleanParameterType dto = new cdp4common.dto.BooleanParameterType(this.iid, this.revisionNumber);
