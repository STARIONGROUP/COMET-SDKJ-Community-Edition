...
public  class DateTimeParameterType extends ScalarParameterType implements Cloneable {
    ...
    /**
     * Initializes a new instance of the {@link DateTimeParameterType} class.
     */
     ...
     */
    public DateTimeParameterType(UUID iid, Cache<Pair<UUID, UUID>, Thing> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this {@link DateTimeParameterType} for edit purpose.
     *
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>DateTimeParameterType}.
     *
    ...
    /**
     * Resolve the properties of the current {@link DateTimeParameterType} from its {@link cdp4common.dto.Thing} counter-part
     *
    ...
    /**
     * Generates a {@link cdp4common.dto.Thing} from the current {@link DateTimeParameterType}
     *
     * @return Generated {@link cdp4common.dto.Thing}
     */
    @Override
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.DateTimeParameterType dto = new cdp4common.dto.DateTimeParameterType(this.getIid(), this.getRevisionNumber());
