...
public abstract class AbstractDomainOfExpertise extends AbstractDefinedThing implements CategorizableThing, DeprecatableThing {
    /**
     ...
     */
    public AbstractDomainOfExpertise() {
     ...
     * @see DomainOfExpertise
     */
    public AbstractDomainOfExpertise(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
    }
    ...
    /**
     * Creates and returns a copy of this <code>DomainOfExpertise<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>DomainOfExpertise<code/>.
     *
     * @see DomainOfExpertise
     * @see Thing
     */
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>DomainOfExpertise<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>DomainOfExpertise<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>DomainOfExpertise<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.DomainOfExpertise dto = new cdp4common.dto.DomainOfExpertise(this.iid, this.revisionNumber);
