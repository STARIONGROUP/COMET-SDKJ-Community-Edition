 ...
 */
public abstract class AbstractSiteDirectory extends AbstractTopContainer implements NamedThing, ShortNamedThing, TimeStampedThing {
    /**
     ...
     * @see SiteDirectory
     */
    public AbstractSiteDirectory(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.annotation = new ContainerList<SiteDirectoryDataAnnotation>(this);
        this.domain = new ContainerList<DomainOfExpertise>(this);
        this.domainGroup = new ContainerList<DomainOfExpertiseGroup>(this);
        this.logEntry = new ContainerList<SiteLogEntry>(this);
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setAnnotation(cloneContainedThings ? new ContainerList<SiteDirectoryDataAnnotation>(clone) : new ContainerList<SiteDirectoryDataAnnotation>(this.annotation, clone));
        clone.setDomain(cloneContainedThings ? new ContainerList<DomainOfExpertise>(clone) : new ContainerList<DomainOfExpertise>(this.domain, clone));
        clone.setDomainGroup(cloneContainedThings ? new ContainerList<DomainOfExpertiseGroup>(clone) : new ContainerList<DomainOfExpertiseGroup>(this.domainGroup, clone));
        clone.setExcludedDomain(new List<DomainOfExpertise>(this.excludedDomain));
        clone.setExcludedPerson(new List<Person>(this.excludedPerson));
        clone.setLogEntry(cloneContainedThings ? new ContainerList<SiteLogEntry>(clone) : new ContainerList<SiteLogEntry>(this.logEntry, clone));
        clone.setModel(cloneContainedThings ? new ContainerList<EngineeringModelSetup>(clone) : new ContainerList<EngineeringModelSetup>(this.model, clone));
        clone.setNaturalLanguage(cloneContainedThings ? new ContainerList<NaturalLanguage>(clone) : new ContainerList<NaturalLanguage>(this.naturalLanguage, clone));
        clone.setOrganization(cloneContainedThings ? new ContainerList<Organization>(clone) : new ContainerList<Organization>(this.organization, clone));
        clone.setParticipantRole(cloneContainedThings ? new ContainerList<ParticipantRole>(clone) : new ContainerList<ParticipantRole>(this.participantRole, clone));
        clone.setPerson(cloneContainedThings ? new ContainerList<Person>(clone) : new ContainerList<Person>(this.person, clone));
        clone.setPersonRole(cloneContainedThings ? new ContainerList<PersonRole>(clone) : new ContainerList<PersonRole>(this.personRole, clone));
        clone.setSiteReferenceDataLibrary(cloneContainedThings ? new ContainerList<SiteReferenceDataLibrary>(clone) : new ContainerList<SiteReferenceDataLibrary>(this.siteReferenceDataLibrary, clone));

        if (cloneContainedThings) {
            clone.getAnnotation().addAll(this.annotation.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getDomain().addAll(this.domain.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getDomainGroup().addAll(this.domainGroup.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getLogEntry().addAll(this.logEntry.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getModel().addAll(this.model.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getNaturalLanguage().addAll(this.naturalLanguage.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getOrganization().addAll(this.organization.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getParticipantRole().addAll(this.participantRole.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getPerson().addAll(this.person.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getPersonRole().addAll(this.personRole.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getSiteReferenceDataLibrary().addAll(this.siteReferenceDataLibrary.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
        }
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.annotation.resolveList(dto.getAnnotation(), dto.getIterationContainerId(), this.cache);
        this.createdOn = dto.getCreatedOn();
        this.defaultParticipantRole = (dto.getDefaultParticipantRole() != null) ? this.cache.get<ParticipantRole>(dto.getDefaultParticipantRole.getValue(), dto.getIterationContainerId()) : null;
        this.defaultPersonRole = (dto.getDefaultPersonRole() != null) ? this.cache.get<PersonRole>(dto.getDefaultPersonRole.getValue(), dto.getIterationContainerId()) : null;
        this.domain.resolveList(dto.getDomain(), dto.getIterationContainerId(), this.cache);
        this.domainGroup.resolveList(dto.getDomainGroup(), dto.getIterationContainerId(), this.cache);
        this.excludedDomain.resolveList(dto.getExcludedDomain(), dto.getIterationContainerId(), this.cache);
        this.excludedPerson.resolveList(dto.getExcludedPerson(), dto.getIterationContainerId(), this.cache);
        this.lastModifiedOn = dto.getLastModifiedOn();
        this.logEntry.resolveList(dto.getLogEntry(), dto.getIterationContainerId(), this.cache);
        this.model.resolveList(dto.getModel(), dto.getIterationContainerId(), this.cache);
        this.modifiedOn = dto.getModifiedOn();
        this.name = dto.getName();
        this.naturalLanguage.resolveList(dto.getNaturalLanguage(), dto.getIterationContainerId(), this.cache);
        this.organization.resolveList(dto.getOrganization(), dto.getIterationContainerId(), this.cache);
        this.participantRole.resolveList(dto.getParticipantRole(), dto.getIterationContainerId(), this.cache);
        this.person.resolveList(dto.getPerson(), dto.getIterationContainerId(), this.cache);
        this.personRole.resolveList(dto.getPersonRole(), dto.getIterationContainerId(), this.cache);
        this.revisionNumber = dto.getRevisionNumber();
        this.shortName = dto.getShortName();
        this.siteReferenceDataLibrary.resolveList(dto.getSiteReferenceDataLibrary(), dto.getIterationContainerId(), this.cache);
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.SiteDirectory dto = new cdp4common.dto.SiteDirectory(this.iid, this.revisionNumber);

        dto.getAnnotation().add(this.annotation.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setCreatedOn(this.createdOn);
        dto.setDefaultParticipantRole(this.defaultParticipantRole != null ? (UUID)this.defaultParticipantRole.getIid() : null);
        dto.setDefaultPersonRole(this.defaultPersonRole != null ? (UUID)this.defaultPersonRole.getIid() : null);
        dto.getDomain().add(this.domain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getDomainGroup().add(this.domainGroup.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedDomain().add(this.excludedDomain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedPerson().add(this.excludedPerson.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setLastModifiedOn(this.lastModifiedOn);
        dto.getLogEntry().add(this.logEntry.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getModel().add(this.model.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setModifiedOn(this.modifiedOn);
        dto.setName(this.name);
        dto.getNaturalLanguage().add(this.naturalLanguage.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getOrganization().add(this.organization.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getParticipantRole().add(this.participantRole.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getPerson().add(this.person.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getPersonRole().add(this.personRole.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setRevisionNumber(this.revisionNumber);
        dto.setShortName(this.shortName);
        dto.getSiteReferenceDataLibrary().add(this.siteReferenceDataLibrary.stream().map(x -> x.Iid).collect(Collectors.toList()));
