...
public abstract class AbstractParameterType extends AbstractDefinedThing implements CategorizableThing, DeprecatableThing {
    /**
     ...
     * @see ParameterType
     */
    protected AbstractParameterType(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
    }
