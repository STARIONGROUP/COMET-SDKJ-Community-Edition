...
public abstract class AbstractScaleValueDefinition extends AbstractDefinedThing  {
    /**
     ...
     */
    public AbstractScaleValueDefinition() {
    }
     ...
     * @see ScaleValueDefinition
     */
    public AbstractScaleValueDefinition(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ScaleValueDefinition dto = new cdp4common.dto.ScaleValueDefinition(this.iid, this.revisionNumber);
