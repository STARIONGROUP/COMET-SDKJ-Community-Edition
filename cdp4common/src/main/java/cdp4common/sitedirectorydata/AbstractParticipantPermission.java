...
public abstract class AbstractParticipantPermission extends AbstractThing implements DeprecatableThing {
    /**
     ...
     */
    public AbstractParticipantPermission() {
    }
     ...
     * @see ParticipantPermission
     */
    public AbstractParticipantPermission(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ParticipantPermission dto = new cdp4common.dto.ParticipantPermission(this.iid, this.revisionNumber);
