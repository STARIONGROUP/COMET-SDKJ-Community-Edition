...
public abstract class AbstractEngineeringModelSetup extends AbstractDefinedThing implements ParticipantAffectedAccessThing {
    /**
     ...
     */
    public AbstractEngineeringModelSetup() {
     ...
     * @see EngineeringModelSetup
     */
    public AbstractEngineeringModelSetup(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.activeDomain = new List<DomainOfExpertise>();
        this.iterationSetup = new ContainerList<IterationSetup>(this);
        this.participant = new ContainerList<Participant>(this);
        this.requiredRdl = new ContainerList<ModelReferenceDataLibrary>(this);
    ...
    private List<DomainOfExpertise> activeDomain;
     ...
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    public List<DomainOfExpertise> getActiveDomain(){
     ...
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
     public void setActiveDomain(List<DomainOfExpertise> activeDomain){
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setActiveDomain(new List<DomainOfExpertise>(this.activeDomain));
        ...
        clone.setIterationSetup(cloneContainedThings ? new ContainerList<IterationSetup>(clone) : new ContainerList<IterationSetup>(this.iterationSetup, clone));
        clone.setParticipant(cloneContainedThings ? new ContainerList<Participant>(clone) : new ContainerList<Participant>(this.participant, clone));
        clone.setRequiredRdl(cloneContainedThings ? new ContainerList<ModelReferenceDataLibrary>(clone) : new ContainerList<ModelReferenceDataLibrary>(this.requiredRdl, clone));
        ...
        if (cloneContainedThings) {
            ...
            clone.getIterationSetup().addAll(this.iterationSetup.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getParticipant().addAll(this.participant.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
            clone.getRequiredRdl().addAll(this.requiredRdl.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
        }
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.activeDomain.resolveList(dto.getActiveDomain(), dto.getIterationContainerId(), this.cache);
        ...
        this.engineeringModelIid = dto.getEngineeringModelIid();
        this.excludedDomain.resolveList(dto.getExcludedDomain(), dto.getIterationContainerId(), this.cache);
        this.excludedPerson.resolveList(dto.getExcludedPerson(), dto.getIterationContainerId(), this.cache);
        this.hyperLink.resolveList(dto.getHyperLink(), dto.getIterationContainerId(), this.cache);
        this.iterationSetup.resolveList(dto.getIterationSetup(), dto.getIterationContainerId(), this.cache);
        this.kind = dto.getKind();
        this.modifiedOn = dto.getModifiedOn();
        this.name = dto.getName();
        this.participant.resolveList(dto.getParticipant(), dto.getIterationContainerId(), this.cache);
        this.requiredRdl.resolveList(dto.getRequiredRdl(), dto.getIterationContainerId(), this.cache);
        this.revisionNumber = dto.getRevisionNumber();
        this.shortName = dto.getShortName();
        this.sourceEngineeringModelSetupIid = dto.getSourceEngineeringModelSetupIid();
        this.studyPhase = dto.getStudyPhase();
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.EngineeringModelSetup dto = new cdp4common.dto.EngineeringModelSetup(this.iid, this.revisionNumber);

        dto.getActiveDomain().add(this.activeDomain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        ...
        dto.setEngineeringModelIid(this.engineeringModelIid);
        dto.getExcludedDomain().add(this.excludedDomain.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getExcludedPerson().add(this.excludedPerson.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getHyperLink().add(this.hyperLink.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getIterationSetup().add(this.iterationSetup.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setKind(this.kind);
        dto.setModifiedOn(this.modifiedOn);
        dto.setName(this.name);
        dto.getParticipant().add(this.participant.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.getRequiredRdl().add(this.requiredRdl.stream().map(x -> x.Iid).collect(Collectors.toList()));
        dto.setRevisionNumber(this.revisionNumber);
        dto.setShortName(this.shortName);
        dto.setSourceEngineeringModelSetupIid(this.sourceEngineeringModelSetupIid);
        dto.setStudyPhase(this.studyPhase);
