/* --------------------------------------------------------------------------------------------------------------------
 * AbstractTextParameterType.java
...
/**
 * representation of a character string valued ScalarParameterType
 */
@Container(clazz = ReferenceDataLibrary.class, propertyName = "parameterType")
public abstract class AbstractTextParameterType extends AbstractScalarParameterType  {
    /**
    ...
    /**
     * Initializes a new instance of the <code>TextParameterType<code/> class.
     *
     * @see TextParameterType
     */
    public AbstractTextParameterType() {
    }
     ...
     * @see TextParameterType
     */
    public AbstractTextParameterType(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this <code>TextParameterType<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>TextParameterType<code/>.
     *
     * @see TextParameterType
     * @see Thing
     */
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        TextParameterType clone = (TextParameterType)this.clone();
     ...
     */
    @Override
    public TextParameterType clone(boolean cloneContainedThings) throws CloneNotSupportedException {
        this.setChangeKind(ChangeKind.UPDATE);

        return (TextParameterType)this.genericClone(cloneContainedThings);
    }

    /**
     * Validates the cardinalities of the properties of this <clone>TextParameterType<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>TextParameterType<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.TextParameterType dto = (cdp4common.dto.TextParameterType)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>TextParameterType<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.TextParameterType dto = new cdp4common.dto.TextParameterType(this.iid, this.revisionNumber);
