...
public abstract class AbstractSiteLogEntry extends AbstractThing implements Annotation, CategorizableThing, LogEntry, TimeStampedThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>SiteLogEntry<code/> class.
     *
     * @see SiteLogEntry
     */
    public AbstractSiteLogEntry() {
     ...
     * @see SiteLogEntry
     */
    public AbstractSiteLogEntry(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.affectedItemIid = new List<UUID>();
        this.category = new List<Category>();
    }
    ...
    /**
     * Creates and returns a copy of this <code>SiteLogEntry<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>SiteLogEntry<code/>.
     *
     * @see SiteLogEntry
     * @see Thing
     */
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        SiteLogEntry clone = (SiteLogEntry)this.clone();
     ...
     */
    @Override
    public SiteLogEntry clone(boolean cloneContainedThings) throws CloneNotSupportedException {
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>SiteLogEntry<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>SiteLogEntry<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>SiteLogEntry<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.SiteLogEntry dto = new cdp4common.dto.SiteLogEntry(this.iid, this.revisionNumber);
