...
public abstract class AbstractMeasurementScale extends AbstractDefinedThing implements DeprecatableThing {
    /**
     ...
     */
    protected AbstractMeasurementScale() {
     ...
     * @see MeasurementScale
     */
    protected AbstractMeasurementScale(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.mappingToReferenceScale = new ContainerList<MappingToReferenceScale>(this);
        this.valueDefinition = new ContainerList<ScaleValueDefinition>(this);
    }
