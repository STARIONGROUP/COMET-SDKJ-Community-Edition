/* --------------------------------------------------------------------------------------------------------------------
 * AbstractDateTimeParameterType.java
...
public abstract class AbstractDateTimeParameterType extends AbstractScalarParameterType  {
    /**
     ...
     */
    public AbstractDateTimeParameterType() {
    }
     ...
     * @see DateTimeParameterType
     */
    public AbstractDateTimeParameterType(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this <code>DateTimeParameterType<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>DateTimeParameterType<code/>.
     *
     * @see DateTimeParameterType
     * @see Thing
     */
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>DateTimeParameterType<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>DateTimeParameterType<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.DateTimeParameterType dto = (cdp4common.dto.DateTimeParameterType)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>DateTimeParameterType<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.DateTimeParameterType dto = new cdp4common.dto.DateTimeParameterType(this.iid, this.revisionNumber);
