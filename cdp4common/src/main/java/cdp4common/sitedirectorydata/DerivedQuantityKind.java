...
public class DerivedQuantityKind extends QuantityKind implements Cloneable {
     ...
     */
    public DerivedQuantityKind(UUID iid, Cache<CacheKey, Thing> cache, URI iDalUri) {
    ...
    /**
     * {@link Iterable} that references the composite properties of the current {@link DerivedQuantityKind}.
     */
    private Iterable<Iterable> containerLists;

    /**
     * Gets a {@link Collection} that references the composite properties of the current {@link DerivedQuantityKind}.
     */
    @Override
    ...
    /**
     * Validate this {@link DerivedQuantityKind} with custom rules
     *
