 ...
 */
public abstract class AbstractReferenceDataLibrary extends AbstractDefinedThing implements ParticipantAffectedAccessThing {
    /**
     ...
     */
    protected AbstractReferenceDataLibrary() {
     ...
     * @see ReferenceDataLibrary
     */
    protected AbstractReferenceDataLibrary(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.baseQuantityKind = new OrderedItemList<QuantityKind>(this);
        this.baseUnit = new List<MeasurementUnit>();
        this.constant = new ContainerList<Constant>(this);
        this.definedCategory = new ContainerList<Category>(this);
    ...
    private List<MeasurementUnit> baseUnit;
     ...
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
    public List<MeasurementUnit> getBaseUnit(){
     ...
     */
    @UmlInformation(aggregation = AggregationKind.NONE, isDerived = false, isOrdered = false, isNullable = false, isPersistent = true)
     public void setBaseUnit(List<MeasurementUnit> baseUnit){
