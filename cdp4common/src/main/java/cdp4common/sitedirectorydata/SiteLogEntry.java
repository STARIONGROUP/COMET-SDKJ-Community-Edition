...
public class SiteLogEntry extends Thing implements Cloneable, Annotation, CategorizableThing, LogEntry, TimeStampedThing {
     ...
     */
    public SiteLogEntry(UUID iid, Cache<CacheKey, Thing> cache, URI iDalUri) {
    ...
    /**
     * {@link Iterable} that references the composite properties of the current {@link SiteLogEntry}.
     */
    private Iterable<Iterable> containerLists;

    /**
     * Gets a {@link Collection} that references the composite properties of the current {@link SiteLogEntry}.
     */
    @Override
