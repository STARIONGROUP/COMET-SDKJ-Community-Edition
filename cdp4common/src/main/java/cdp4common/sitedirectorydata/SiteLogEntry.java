...
@ToString
@EqualsAndHashCode
public  class SiteLogEntry extends Thing implements Annotation, CategorizableThing, LogEntry, TimeStampedThing {
    /**
     ...
     * @see SiteLogEntry
     */
    public SiteLogEntry(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.affectedItemIid = new ArrayList<UUID>();
        this.category = new ArrayList<Category>();
    }
