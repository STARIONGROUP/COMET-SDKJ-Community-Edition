...
public abstract class AbstractOrganization extends AbstractThing implements DeprecatableThing, NamedThing, ShortNamedThing {
    /**
     ...
     * @see Organization
     */
    public AbstractOrganization(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Organization dto = new cdp4common.dto.Organization(this.iid, this.revisionNumber);
