...
public abstract class AbstractSimpleUnit extends AbstractMeasurementUnit  {
    /**
     ...
     * @see SimpleUnit
     */
    public AbstractSimpleUnit(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this <code>SimpleUnit<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>SimpleUnit<code/>.
     *
     * @see SimpleUnit
     * @see Thing
     */
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        SimpleUnit clone = (SimpleUnit)this.clone();
     ...
     */
    @Override
    public SimpleUnit clone(boolean cloneContainedThings) throws CloneNotSupportedException {
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>SimpleUnit<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>SimpleUnit<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.SimpleUnit dto = (cdp4common.dto.SimpleUnit)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>SimpleUnit<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.SimpleUnit dto = new cdp4common.dto.SimpleUnit(this.iid, this.revisionNumber);
