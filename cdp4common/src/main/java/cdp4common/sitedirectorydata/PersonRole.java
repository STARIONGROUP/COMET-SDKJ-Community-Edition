...
@ToString
@EqualsAndHashCode
public  class PersonRole extends DefinedThing implements DeprecatableThing {
    /**
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.personPermission.resolveList(dto.getPersonPermission(), dto.getIterationContainerId(), this.getCache());
