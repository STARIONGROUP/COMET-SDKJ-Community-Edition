...
public class ModelReferenceDataLibrary extends ReferenceDataLibrary implements Cloneable {
     ...
     */
    public ModelReferenceDataLibrary(UUID iid, Cache<CacheKey, Thing> cache, URI iDalUri) {
    ...
    /**
     * Validates the cardinalities of the properties of this ModelReferenceDataLibrary}.
     *
