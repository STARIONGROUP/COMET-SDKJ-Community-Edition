...
public  class EnumerationValueDefinition extends DefinedThing implements Cloneable {
     ...
     */
    public EnumerationValueDefinition(UUID iid, Cache<Pair<UUID, UUID>, Thing> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this {@link EnumerationValueDefinition} for edit purpose.
     *
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>EnumerationValueDefinition}.
     *
    ...
    /**
     * Resolve the properties of the current {@link EnumerationValueDefinition} from its {@link cdp4common.dto.Thing} counter-part
     *
    ...
    /**
     * Generates a {@link cdp4common.dto.Thing} from the current {@link EnumerationValueDefinition}
     *
