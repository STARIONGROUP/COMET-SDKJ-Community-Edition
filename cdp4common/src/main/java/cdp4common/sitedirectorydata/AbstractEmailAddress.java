...
public abstract class AbstractEmailAddress extends AbstractThing  {
    /**
     ...
     * @see EmailAddress
     */
    public AbstractEmailAddress(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.vcardType = dto.getVcardType();
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.EmailAddress dto = new cdp4common.dto.EmailAddress(this.iid, this.revisionNumber);
        ...
        dto.setVcardType(this.vcardType);
