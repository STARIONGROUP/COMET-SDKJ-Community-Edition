...
public class BinaryRelationshipRule extends Rule implements Cloneable {
    ...
    public void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.setSourceCategory(this.getCache().get<Category>(dto.getSourceCategory(), dto.getIterationContainerId()) ?? SentinelThingProvider.getSentinel(Category.class));
        this.setTargetCategory(this.getCache().get<Category>(dto.getTargetCategory(), dto.getIterationContainerId()) ?? SentinelThingProvider.getSentinel(Category.class));
