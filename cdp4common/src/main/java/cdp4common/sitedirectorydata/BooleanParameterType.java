...
public  class BooleanParameterType extends ScalarParameterType implements Cloneable {
    ...
    protected Thing genericClone(boolean cloneContainedThings) {
        BooleanParameterType clone;
        try {
            clone = (BooleanParameterType)this.clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
            throw new IllegalAccessError("Somehow BooleanParameterType cannot be cloned.");
        }
     ...
     */
    @Override
    public BooleanParameterType clone(boolean cloneContainedThings) {
