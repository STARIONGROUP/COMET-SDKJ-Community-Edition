...
public abstract class AbstractConstant extends AbstractDefinedThing implements CategorizableThing, DeprecatableThing {
    /**
     ...
     * @see Constant
     */
    public AbstractConstant(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new List<Category>();
        this.value = new ValueArray<String>(this);
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Constant dto = new cdp4common.dto.Constant(this.iid, this.revisionNumber);
