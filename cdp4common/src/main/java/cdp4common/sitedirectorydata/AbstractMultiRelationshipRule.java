...
public abstract class AbstractMultiRelationshipRule extends AbstractRule  {
    /**
     ...
     */
    public AbstractMultiRelationshipRule() {
     ...
     * @see MultiRelationshipRule
     */
    public AbstractMultiRelationshipRule(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.relatedCategory = new List<Category>();
    }
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setRelatedCategory(new List<Category>(this.relatedCategory));
    ...
    protected Iterable<String> validatePocoCardinality() {
        ...
        int relatedCategoryCount = this.relatedCategory.size();
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.maxRelated = dto.getMaxRelated();
        this.minRelated = dto.getMinRelated();
        this.modifiedOn = dto.getModifiedOn();
        this.name = dto.getName();
        this.relatedCategory.resolveList(dto.getRelatedCategory(), dto.getIterationContainerId(), this.cache);
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.MultiRelationshipRule dto = new cdp4common.dto.MultiRelationshipRule(this.iid, this.revisionNumber);
        ...
        dto.setMaxRelated(this.maxRelated);
        dto.setMinRelated(this.minRelated);
        dto.setModifiedOn(this.modifiedOn);
        dto.setName(this.name);
        dto.getRelatedCategory().add(this.relatedCategory.stream().map(x -> x.Iid).collect(Collectors.toList()));
