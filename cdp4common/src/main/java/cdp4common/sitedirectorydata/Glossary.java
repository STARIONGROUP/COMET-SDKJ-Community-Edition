...
@ToString
@EqualsAndHashCode
public  class Glossary extends DefinedThing implements CategorizableThing, DeprecatableThing {
    /**
     ...
     * @see Glossary
     */
    public Glossary(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.category = new ArrayList<Category>();
        this.term = new ContainerList<Term>(this);
    }
