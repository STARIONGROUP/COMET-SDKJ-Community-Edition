...
public  class Glossary extends DefinedThing implements Cloneable, CategorizableThing, DeprecatableThing {
    ...
    /**
     * Gets an {@link List<List<Thing>>} that references the composite properties of the current {@link Glossary}.
     */
    @Override
    ...
    protected Thing genericClone(boolean cloneContainedThings) {
        ...
        clone.setTerm(cloneContainedThings ? new ContainerList<Term>(clone) : new ContainerList<Term>(this.getTerm(), clone));
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>Glossary}.
     *
