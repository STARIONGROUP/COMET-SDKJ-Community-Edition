...
public abstract class AbstractParameterTypeComponent extends AbstractThing implements ShortNamedThing {
    /**
     ...
     */
    public AbstractParameterTypeComponent() {
    }
     ...
     * @see ParameterTypeComponent
     */
    public AbstractParameterTypeComponent(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ParameterTypeComponent dto = new cdp4common.dto.ParameterTypeComponent(this.iid, this.revisionNumber);
