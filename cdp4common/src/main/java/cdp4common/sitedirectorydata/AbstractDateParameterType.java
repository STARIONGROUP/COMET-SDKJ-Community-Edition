/* --------------------------------------------------------------------------------------------------------------------
 * AbstractDateParameterType.java
...
public abstract class AbstractDateParameterType extends AbstractScalarParameterType  {
    /**
     ...
     */
    public AbstractDateParameterType() {
    }
     ...
     * @see DateParameterType
     */
    public AbstractDateParameterType(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this <code>DateParameterType<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>DateParameterType<code/>.
     *
     * @see DateParameterType
     * @see Thing
     */
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        DateParameterType clone = (DateParameterType)this.clone();
     ...
     */
    @Override
    public DateParameterType clone(boolean cloneContainedThings) throws CloneNotSupportedException {
        this.setChangeKind(ChangeKind.UPDATE);

        return (DateParameterType)this.genericClone(cloneContainedThings);
    }

    /**
     * Validates the cardinalities of the properties of this <clone>DateParameterType<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>DateParameterType<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.DateParameterType dto = (cdp4common.dto.DateParameterType)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>DateParameterType<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.DateParameterType dto = new cdp4common.dto.DateParameterType(this.iid, this.revisionNumber);
