...
public abstract class AbstractTerm extends AbstractDefinedThing implements DeprecatableThing {
    /**
     ...
     * @see Term
     */
    public AbstractTerm(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Term dto = new cdp4common.dto.Term(this.iid, this.revisionNumber);
