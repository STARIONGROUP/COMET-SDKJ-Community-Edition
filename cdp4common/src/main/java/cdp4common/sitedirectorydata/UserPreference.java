...
public class UserPreference extends Thing implements Cloneable, ShortNamedThing {
     ...
     */
    public UserPreference(UUID iid, Cache<CacheKey, Thing> cache, URI iDalUri) {
    ...
    /**
     * Resolve the properties of the current {@link UserPreference} from its {@link cdp4common.dto.Thing} counter-part
     *
    ...
    public void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.UserPreference dto = (cdp4common.dto.UserPreference)dtoThing;
    ...
    /**
     * Generates a {@link cdp4common.dto.Thing} from the current {@link UserPreference}
     *
