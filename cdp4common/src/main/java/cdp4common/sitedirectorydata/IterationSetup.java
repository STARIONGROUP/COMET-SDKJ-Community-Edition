...
public class IterationSetup extends AbstractIterationSetup {
    /**
     ...
     * @see IterationSetup
     */
    public IterationSetup(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
