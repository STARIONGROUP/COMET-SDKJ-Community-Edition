...
public abstract class AbstractRule extends AbstractDefinedThing implements DeprecatableThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>Rule<code/> class.
     *
     * @see Rule
     */
     ...
     * @see Rule
     */
    protected AbstractRule(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    /**
     * Creates and returns a copy of this <code>Rule<code/> for edit purpose.
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>Rule<code/>.
     * 
     * @see Rule
     */
    @Override
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>Rule<code/>.
     *
