...
public abstract class AbstractMeasurementUnit extends AbstractDefinedThing implements DeprecatableThing {
    /**
     ...
     * @see MeasurementUnit
     */
    protected AbstractMeasurementUnit() {
    }
     ...
     * @see MeasurementUnit
     */
    protected AbstractMeasurementUnit(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
