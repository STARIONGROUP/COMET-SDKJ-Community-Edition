...
public  class Book extends Thing implements Cloneable, CategorizableThing, NamedThing, OwnedThing, ShortNamedThing, TimeStampedThing {
    ...
    /**
     * Gets an {@link List<List<Thing>>} that references the composite properties of the current {@link Book}.
     */
    @Override
    ...
    /**
     * Creates and returns a copy of this {@link Book} for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained {@link Thing}s should be cloned or not.
     *
     * @return A cloned instance of {@link Book}.
     */
    @Override
    protected Thing genericClone(boolean cloneContainedThings) {
        Book clone;
        try {
            clone = (Book)this.clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
            throw new IllegalAccessError("Somehow Book cannot be cloned.");
        }
     ...
     */
    @Override
    public Book clone(boolean cloneContainedThings) {
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>Book}.
     *
    ...
    /**
     * Resolve the properties of the current {@link Book} from its {@link cdp4common.dto.Thing} counter-part
     *
    ...
    public void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.getSection().resolveList(dto.getSection(), dto.getIterationContainerId(), this.getCache());
    ...
    /**
     * Generates a {@link cdp4common.dto.Thing} from the current {@link Book}
     *
