...
public abstract class AbstractThingReference extends AbstractThing  {
    /**
     ...
     * @see ThingReference
     */
    protected AbstractThingReference() {
    }
     ...
     * @see ThingReference
     */
    protected AbstractThingReference(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    protected Iterable<String> validatePocoCardinality() {
        ...
        if (this.referencedThing == null || this.referencedThing.getIid().equals(new UUID(0L, 0L))) {
