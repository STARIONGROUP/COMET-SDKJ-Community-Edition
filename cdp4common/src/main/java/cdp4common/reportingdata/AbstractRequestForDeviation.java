...
public abstract class AbstractRequestForDeviation extends AbstractContractDeviation  {
    /**
     ...
     */
    public AbstractRequestForDeviation() {
    }
     ...
     * @see RequestForDeviation
     */
    public AbstractRequestForDeviation(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.RequestForDeviation dto = new cdp4common.dto.RequestForDeviation(this.iid, this.revisionNumber);
