...
@ToString
@EqualsAndHashCode
public  class ChangeRequest extends ContractDeviation  {
    /**
     ...
     */
    public ChangeRequest(UUID iid, Cache<Pair<UUID, UUID>, Thing> cache, URI iDalUri) {
    }
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>ChangeRequest}.
     *
