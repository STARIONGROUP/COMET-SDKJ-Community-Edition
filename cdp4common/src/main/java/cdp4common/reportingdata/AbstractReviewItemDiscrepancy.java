...
public abstract class AbstractReviewItemDiscrepancy extends AbstractModellingAnnotationItem  {
    /**
     ...
     */
    public AbstractReviewItemDiscrepancy() {
     ...
     * @see ReviewItemDiscrepancy
     */
    public AbstractReviewItemDiscrepancy(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.solution = new ContainerList<Solution>(this);
    }
    ...
    protected Thing genericClone(boolean cloneContainedThings) throws CloneNotSupportedException {
        ...
        clone.setSolution(cloneContainedThings ? new ContainerList<Solution>(clone) : new ContainerList<Solution>(this.solution, clone));
        ...
        if (cloneContainedThings) {
            ...
            clone.getSolution().addAll(this.solution.stream().map(x -> x.Clone(true)).collect(Collectors.toList());
        }
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.solution.resolveList(dto.getSolution(), dto.getIterationContainerId(), this.cache);
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.ReviewItemDiscrepancy dto = new cdp4common.dto.ReviewItemDiscrepancy(this.iid, this.revisionNumber);
        ...
        dto.getSolution().add(this.solution.stream().map(x -> x.Iid).collect(Collectors.toList()));
