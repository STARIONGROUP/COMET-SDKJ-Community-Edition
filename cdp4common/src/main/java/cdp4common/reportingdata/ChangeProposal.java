...
public class ChangeProposal extends ModellingAnnotationItem implements Cloneable {
     ...
     */
    public ChangeProposal(UUID iid, Cache<CacheKey, Thing> cache, URI iDalUri) {
    ...
    public void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        this.setChangeRequest(ObjectUtils.firstNonNull(PojoThingFactory.get(this.getCache(), dto.getChangeRequest(), dto.getIterationContainerId(), ChangeRequest.class), SentinelThingProvider.getSentinel(ChangeRequest.class)));
