...
public  abstract class GenericAnnotation extends Thing implements Cloneable, Annotation, TimeStampedThing {
    ...
    /**
     * Initializes a new instance of the {@link GenericAnnotation} class.
     */
     ...
     */
    protected GenericAnnotation(UUID iid, Cache<Pair<UUID, UUID>, Thing> cache, URI iDalUri) {
    }
    ...
    /**
     * Creates and returns a copy of this {@link GenericAnnotation} for edit purpose.
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>GenericAnnotation}.
     *
