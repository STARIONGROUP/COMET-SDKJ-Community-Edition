...
public  class RequestForWaiver extends ContractDeviation  {
     ...
     */
    public RequestForWaiver(UUID iid, Cache<Pair<UUID, UUID>, Thing> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this {@link RequestForWaiver} for edit purpose.
     *
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>RequestForWaiver}.
     *
    ...
    /**
     * Resolve the properties of the current {@link RequestForWaiver} from its {@link cdp4common.dto.Thing} counter-part
     *
    ...
    /**
     * Generates a {@link cdp4common.dto.Thing} from the current {@link RequestForWaiver}
     *
