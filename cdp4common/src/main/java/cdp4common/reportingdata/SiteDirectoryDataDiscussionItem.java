...
public class SiteDirectoryDataDiscussionItem extends AbstractSiteDirectoryDataDiscussionItem {
    /**
     ...
     * @see SiteDirectoryDataDiscussionItem
     */
    public SiteDirectoryDataDiscussionItem(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
