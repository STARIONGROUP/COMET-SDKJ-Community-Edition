...
public abstract class AbstractEngineeringModelDataAnnotation extends AbstractGenericAnnotation  {
    /**
     ...
     */
    protected AbstractEngineeringModelDataAnnotation() {
     ...
     * @see EngineeringModelDataAnnotation
     */
    protected AbstractEngineeringModelDataAnnotation(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
        this.discussion = new ContainerList<EngineeringModelDataDiscussionItem>(this);
        this.relatedThing = new ContainerList<ModellingThingReference>(this);
    }
