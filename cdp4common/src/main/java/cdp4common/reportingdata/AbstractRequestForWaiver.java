...
public abstract class AbstractRequestForWaiver extends AbstractContractDeviation  {
    /**
     ...
     */
    public AbstractRequestForWaiver() {
    }
     ...
     * @see RequestForWaiver
     */
    public AbstractRequestForWaiver(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }

    /**
     * Creates and returns a copy of this <code>RequestForWaiver<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>RequestForWaiver<code/>.
     *
     * @see RequestForWaiver
     * @see Thing
     */
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>RequestForWaiver<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>RequestForWaiver<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    void resolveProperties(cdp4common.dto.Thing dtoThing) {
        ...
        cdp4common.dto.RequestForWaiver dto = (cdp4common.dto.RequestForWaiver)dtoThing;
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>RequestForWaiver<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.RequestForWaiver dto = new cdp4common.dto.RequestForWaiver(this.iid, this.revisionNumber);
