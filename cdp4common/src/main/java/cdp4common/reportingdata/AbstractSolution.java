...
public abstract class AbstractSolution extends AbstractGenericAnnotation implements OwnedThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>Solution<code/> class.
     *
     * @see Solution
     */
     ...
     * @see Solution
     */
    public AbstractSolution(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    /**
     * Creates and returns a copy of this <code>Solution<code/> for edit purpose.
     *
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>Solution<code/>.
     *
     * @see Solution
     * @see Thing
     */
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>Solution<code/>.
     *
    ...
    /**
     * Resolve the properties of the current <code>Solution<code/> from its <code>cdp4common.dto.Thing<code/> counter-part
     *
    ...
    /**
     * Generates a <code>cdp4common.dto.Thing<code/> from the current <code>Solution<code/>
     *
    ...
    public cdp4common.dto.Thing toDto() {
        cdp4common.dto.Solution dto = new cdp4common.dto.Solution(this.iid, this.revisionNumber);
