/* --------------------------------------------------------------------------------------------------------------------
 * AbstractGenericAnnotation.java
...
/**
 * Super abstract class that represents an Annotation made on a Thing
 */
@CDPVersion(version = "1.1.0")
public abstract class AbstractGenericAnnotation extends AbstractThing implements Annotation, TimeStampedThing {
    /**
    ...
    /**
     * Initializes a new instance of the <code>GenericAnnotation<code/> class.
     *
     * @see GenericAnnotation
     */
    protected AbstractGenericAnnotation() {
    }
     ...
     * @see GenericAnnotation
     */
    protected AbstractGenericAnnotation(UUID iid, ConcurrentHashMap<Pair<UUID, UUID>, Lazy<Thing>> cache, URI iDalUri) {
    }
    ...
    /**
     * Creates and returns a copy of this <code>GenericAnnotation<code/> for edit purpose.
     * @param cloneContainedThings A value that indicates whether the contained <code>Thing<code/>s should be cloned or not.
     *
     * @return A cloned instance of <code>GenericAnnotation<code/>.
     * 
     * @see GenericAnnotation
     */
    @Override
    ...
    /**
     * Validates the cardinalities of the properties of this <clone>GenericAnnotation<code/>.
     *
