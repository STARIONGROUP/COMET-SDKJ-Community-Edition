...
/**
 * Version identifier for bundles and packages. This is basically a slightly modified copy of
 * http://www.docjar.com/html/api/org/osgi/framework/Version.java.html that is distributed under the
...
public class Version implements Comparable {
   ...
   * will be ignored.
   * @return A <code>Version</code> object representing the version identifier. If
   * <code>version</code> is <code>null</code> or
   * the empty string then <code>emptyVersion</code> will be returned.
   * @throws IllegalArgumentException If <code>version</code> is improperly formatted.
   */
   ...
   *
   * <p>
   * The format of the version string will be <code>major.minor.micro</code> if qualifier is the
   * empty string or
   ...
   * components are equal and the qualifier component is equal (using <code>String.equals</code>).
   *
   ...
   * version's qualifier component (using
