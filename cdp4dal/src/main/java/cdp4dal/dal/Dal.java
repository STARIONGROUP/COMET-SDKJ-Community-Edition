...
import cdp4dal.dal.protocol.QueryAttributes;
...
public interface Dal {
   ...
   * {@link Thing}.
   */
  <T extends Thing> CompletableFuture<List<Thing>> read(T thing, Boolean cancelled,
   ...
   * will be returned.
   */
  CompletableFuture<List<Thing>> read(Iteration iteration, Boolean cancelled,
      QueryAttributes attributes);
   ...
   * SiteDirectory}.
   */
  CompletableFuture<List<Thing>> open(Credentials credentials, Boolean cancelled);
