 ...
 * </p>
 * <ul>
 *   <li>{@link CDP4.EngineeringModelData.impl.OrExpressionImpl#getTerm <em>Term</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrExpressionImpl extends BooleanExpressionImpl implements OrExpression {
	...
	protected EClass eStaticClass() {
		return EngineeringModelDataPackage.Literals.OR_EXPRESSION;
	}
	...
	public EList<BooleanExpression> getTerm() {
		if (term == null) {
			term = new EObjectResolvingEList<BooleanExpression>(BooleanExpression.class, this, EngineeringModelDataPackage.OR_EXPRESSION__TERM);
		}
		return term;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EngineeringModelDataPackage.OR_EXPRESSION__TERM:
				return getTerm();
		}
