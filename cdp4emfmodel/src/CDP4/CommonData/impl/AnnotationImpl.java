 ...
 * </p>
 * <ul>
 *   <li>{@link CDP4.CommonData.impl.AnnotationImpl#getLanguageCode <em>Language Code</em>}</li>
 *   <li>{@link CDP4.CommonData.impl.AnnotationImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AnnotationImpl extends MinimalEObjectImpl.Container implements Annotation {
	...
	protected EClass eStaticClass() {
		return CommonDataPackage.Literals.ANNOTATION;
	}
	...
	public void setLanguageCode(String newLanguageCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonDataPackage.ANNOTATION__LANGUAGE_CODE, oldLanguageCode, languageCode));
	}
	...
	public void setContent(String newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonDataPackage.ANNOTATION__CONTENT, oldContent, content));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommonDataPackage.ANNOTATION__LANGUAGE_CODE:
				return getLanguageCode();
			case CommonDataPackage.ANNOTATION__CONTENT:
				return getContent();
		}
