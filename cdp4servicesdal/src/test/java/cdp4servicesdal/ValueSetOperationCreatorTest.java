...
class ValueSetOperationCreatorTest {
  ...
  @Test
  void verifyThatCreateValueSetsUpdateOperationsWorks() throws InstanceNotFoundException {
    ...
    var operation = operationContainer.getOperations()
        .stream()
        .filter(x -> x.getOriginalThing().CLASS_KIND == ClassKind.PARAMETER_VALUE_SET)
