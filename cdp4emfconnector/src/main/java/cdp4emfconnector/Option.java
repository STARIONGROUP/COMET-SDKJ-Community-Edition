...
public class Option {
    ...
    public static CDP4.EngineeringModelData.Option toEmf(cdp4common.engineeringmodeldata.Option thing) {       
        ...
        emf.getNestedElement().addAll(thing.getNestedElement().stream().map(item -> cdp4emfconnector.NestedElement.toEmf(item)).collect(Collectors.toList()));
    ...
    public static cdp4common.engineeringmodeldata.Option toPojo(CDP4.EngineeringModelData.Option emfThing) {
        ...
        pojo.getNestedElement().addAll(emfThing.getNestedElement().stream().map(item -> cdp4emfconnector.NestedElement.toPojo(item)).collect(Collectors.toList()));              
