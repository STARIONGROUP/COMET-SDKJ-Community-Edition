...
public class IterationSetup {
    ...
    public static CDP4.SiteDirectoryData.IterationSetup toEmf(cdp4common.sitedirectorydata.IterationSetup thing) {       
        ...
        emf.setFrozenOn(thing.getFrozenOn());
        
        emf.setIsDeleted(thing.isDeleted());
        
        emf.setIterationIid(thing.getIterationIid().toString());
        
        emf.setIterationNumber(thing.getIterationNumber());
    ...
    public static cdp4common.sitedirectorydata.IterationSetup toPojo(CDP4.SiteDirectoryData.IterationSetup emfThing) {
        ...
        pojo.setFrozenOn(emfThing.getFrozenOn());
        
        pojo.setDeleted(emfThing.getIsDeleted());
        
        pojo.setIterationIid(UUID.fromString(emfThing.getIterationIid()));
        
        pojo.setIterationNumber(emfThing.getIterationNumber());
