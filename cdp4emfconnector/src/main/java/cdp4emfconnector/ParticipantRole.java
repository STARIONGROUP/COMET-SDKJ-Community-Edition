...
public class ParticipantRole {
    ...
    public static CDP4.SiteDirectoryData.ParticipantRole toEmf(cdp4common.sitedirectorydata.ParticipantRole thing) {       
        ...
        emf.getParticipantPermission().addAll(thing.getParticipantPermission().stream().map(item -> cdp4emfconnector.ParticipantPermission.toEmf(item)).collect(Collectors.toList()));
    ...
    public static  cdp4common.sitedirectorydata.ParticipantRole toPojo(CDP4.SiteDirectoryData.ParticipantRole emfThing) {
        ...
        pojo.getParticipantPermission().addAll(emfThing.getParticipantPermission().stream().map(item -> cdp4emfconnector.ParticipantPermission.toPojo(item)).collect(Collectors.toList()));              
