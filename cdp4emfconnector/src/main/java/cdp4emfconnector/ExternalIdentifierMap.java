...
public class ExternalIdentifierMap {
    ...
    public static CDP4.EngineeringModelData.ExternalIdentifierMap toEmf(cdp4common.engineeringmodeldata.ExternalIdentifierMap thing) {       
        ...
        emf.getCorrespondence().addAll(thing.getCorrespondence().stream().map(item -> cdp4emfconnector.IdCorrespondence.toEmf(item)).collect(Collectors.toList()));
        
        emf.getExcludedDomain().addAll(thing.getExcludedDomain().stream().map(item -> cdp4emfconnector.DomainOfExpertise.toEmf(item)).collect(Collectors.toList()));
        
        emf.getExcludedPerson().addAll(thing.getExcludedPerson().stream().map(item -> cdp4emfconnector.Person.toEmf(item)).collect(Collectors.toList()));
        
        emf.setExternalFormat(thing.getExternalFormat() != null ? cdp4emfconnector.ReferenceSource.toEmf(thing.getExternalFormat()) : null);
        emf.setExternalModelName(thing.getExternalModelName());
        
        emf.setExternalToolName(thing.getExternalToolName());
        
        emf.setExternalToolVersion(thing.getExternalToolVersion());
    ...
    public static cdp4common.engineeringmodeldata.ExternalIdentifierMap toPojo(CDP4.EngineeringModelData.ExternalIdentifierMap emfThing) {
        ...
        pojo.getCorrespondence().addAll(emfThing.getCorrespondence().stream().map(item -> cdp4emfconnector.IdCorrespondence.toPojo(item)).collect(Collectors.toList()));              
        
        pojo.getExcludedDomain().addAll(emfThing.getExcludedDomain().stream().map(item -> cdp4emfconnector.DomainOfExpertise.toPojo(item)).collect(Collectors.toList()));              
        
        pojo.getExcludedPerson().addAll(emfThing.getExcludedPerson().stream().map(item -> cdp4emfconnector.Person.toPojo(item)).collect(Collectors.toList()));              
        
        pojo.setExternalFormat(emfThing.getExternalFormat() != null ? cdp4emfconnector.ReferenceSource.toPojo(emfThing.getExternalFormat()) : null);
        pojo.setExternalModelName(emfThing.getExternalModelName());
        
        pojo.setExternalToolName(emfThing.getExternalToolName());
        
        pojo.setExternalToolVersion(emfThing.getExternalToolVersion());
