...
public class Citation {
    ...
    public static CDP4.CommonData.Citation toEmf(cdp4common.commondata.Citation thing) {       
        ...
        emf.setIsAdaptation(thing.isAdaptation());
        
        emf.setLocation(thing.getLocation());
        
        emf.setModifiedOn(thing.getModifiedOn());
        
        emf.setRemark(thing.getRemark());
    ...
    public static cdp4common.commondata.Citation toPojo(CDP4.CommonData.Citation emfThing) {
        ...
        pojo.setAdaptation(emfThing.getIsAdaptation());
        
        pojo.setLocation(emfThing.getLocation());
        
        pojo.setModifiedOn(emfThing.getModifiedOn());
        
        pojo.setRemark(emfThing.getRemark());
