...
public class ParameterGroup {
    ...
    public static CDP4.EngineeringModelData.ParameterGroup toEmf(cdp4common.engineeringmodeldata.ParameterGroup thing) {       
        ...
        emf.setContainingGroup(thing.getContainingGroup() != null ? cdp4emfconnector.ParameterGroup.toEmf(thing.getContainingGroup()) : null);
    ...
    public static cdp4common.engineeringmodeldata.ParameterGroup toPojo(CDP4.EngineeringModelData.ParameterGroup emfThing) {
        ...
        pojo.setContainingGroup(emfThing.getContainingGroup() != null ? cdp4emfconnector.ParameterGroup.toPojo(emfThing.getContainingGroup()) : null);
