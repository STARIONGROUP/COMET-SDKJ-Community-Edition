...
/**
 * Static resource that allows to change representation of the {@link RequestForWaiver} class.
 */
public class RequestForWaiver {
   
    /**
     * Convert from {@link cdp4common.reportingdata.RequestForWaiver} to {@link CDP4.ReportingData.RequestForWaiver}
     *
     * @return Generated {@link CDP4.ReportingData.RequestForWaiver}
     */
    public static CDP4.ReportingData.RequestForWaiver toEmf(cdp4common.reportingdata.RequestForWaiver thing) {       
        
        CDP4.ReportingData.RequestForWaiver emf =  CDP4.ReportingData.impl.ReportingDataFactoryImpl.eINSTANCE.createRequestForWaiver();      
    ...
    /**
     * Convert from {@link CDP4.ReportingData.RequestForWaiver} to {@link cdp4common.reportingdata.RequestForWaiver}
     *
     * @return Generated {@link cdp4common.reportingdata.RequestForWaiver}
     */
    public static cdp4common.reportingdata.RequestForWaiver toPojo(CDP4.ReportingData.RequestForWaiver emfThing) {
        
        cdp4common.reportingdata.RequestForWaiver pojo = new cdp4common.reportingdata.RequestForWaiver();
    ...
    /**
    * Instantiate a {@link cdp4common.reportingdata.RequestForWaiver} from a {@link CDP4.ReportingData.RequestForWaiver}
    *
    * @param cache The cache that stores all the {@link cdp4common.commondata.Thing}
    * @param uri The {@link URI} of the {@link cdp4common.reportingdata.RequestForWaiver}.
    * @return A new {@link cdp4common.reportingdata.RequestForWaiver}
    */
    public static cdp4common.reportingdata.RequestForWaiver instiatePojo(CDP4.ReportingData.RequestForWaiver thing, Cache<CacheKey, cdp4common.commondata.Thing> cache, URI uri) {
       return new cdp4common.reportingdata.RequestForWaiver(UUID.fromString(thing.getIid()), cache, uri);
    }
}
