...
public class NestedElement {
    ...
    public static CDP4.EngineeringModelData.NestedElement toEmf(cdp4common.engineeringmodeldata.NestedElement thing) {       
        ...
        emf.getElementUsage().addAll(thing.getElementUsage().stream().map(item -> cdp4emfconnector.ElementUsage.toEmf(item)).collect(Collectors.toList()));
        ...
        emf.getNestedParameter().addAll(thing.getNestedParameter().stream().map(item -> cdp4emfconnector.NestedParameter.toEmf(item)).collect(Collectors.toList()));
    ...
    public static  cdp4common.engineeringmodeldata.NestedElement toPojo(CDP4.EngineeringModelData.NestedElement emfThing) {
        ...
        pojo.getElementUsage().addAll(emfThing.getElementUsage().stream().map(item -> cdp4emfconnector.ElementUsage.toPojo(item)).collect(Collectors.toList()));
        ...
        pojo.getNestedParameter().addAll(emfThing.getNestedParameter().stream().map(item -> cdp4emfconnector.NestedParameter.toPojo(item)).collect(Collectors.toList()));              
